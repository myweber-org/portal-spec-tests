...
mod tests {
    ...
    fn test_encryption_roundtrip() {
        ...
        let dummy_key = "000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f";
        
        encrypt_file(input_file.path(), encrypted_file.path()).unwrap();
        decrypt_file(encrypted_file.path(), decrypted_file.path(), dummy_key).unwrap();
