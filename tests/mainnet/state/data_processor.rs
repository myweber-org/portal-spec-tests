...
mod tests {
    ...
    fn test_data_processor() {
        ...
        writeln!(temp_file, "3,,30.0,2023-01-03").unwrap();
        ...
        assert!(avg.is_some());
        assert_eq!(avg.unwrap(), 20.166666666666668);
...
pub fn process_records(records: &mut [DataRecord], multiplier: f64) -> Result<usize, DataError> {
