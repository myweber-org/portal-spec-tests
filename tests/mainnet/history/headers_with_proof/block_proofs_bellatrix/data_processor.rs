...
mod tests {
    ...
    fn test_process_valid_data() {
        ...
        writeln!(temp_file, "2,Test2,15.2,CategoryB").unwrap();
    ...
    fn test_calculate_stats() {
        let records = vec![
            ...
            Record { id: 3, name: "C".to_string(), value: 30.0, category: "Cat3".to_string() },
        ];
...
impl DataProcessor {
    ...
    pub fn find_by_id(records: &[Record], id: u32) -> Option<&Record> {
...
mod tests {
    ...
    fn test_filter_and_calculate() {
        ...
        let found = DataProcessor::find_by_id(&records, 2);
