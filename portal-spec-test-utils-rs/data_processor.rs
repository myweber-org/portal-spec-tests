...
mod tests {
    ...
    fn test_filter_and_statistics() {
        ...
        processor.records.push(DataRecord::new(2, 20.0, "A".to_string(), "ts2".to_string()));
        processor.records.push(DataRecord::new(3, 30.0, "B".to_string(), "ts3".to_string()));
...
mod tests {
    ...
    fn test_data_processor() {
        ...
        assert!(invalid_indices.is_empty());
...
mod tests {
    ...
    fn test_data_record_creation() {
        ...
        let result = DataRecord::new(2, -1.0, "test");
...
mod tests {
    ...
    fn test_csv_import() -> Result<(), Box<dyn Error>> {
        ...
        assert_eq!(ds.get_count(), 3);
        assert_eq!(ds.calculate_mean(), Some(25.5));
