...
mod tests {
    ...
    fn test_different_keys_produce_different_results() {
        ...
        xor_encrypt_file(input_file.path(), output1.path(), Some(0x10)).unwrap();
        xor_encrypt_file(input_file.path(), output2.path(), Some(0x20)).unwrap();
