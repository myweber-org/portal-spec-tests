...
mod tests {
    ...
    fn test_aes_encryption_decryption() {
        ...
        let decrypted = decrypt_data(&result.ciphertext, &result.nonce, CipherAlgorithm::Aes256Gcm).unwrap();
    ...
    fn test_chacha_encryption_decryption() {
        ...
        let decrypted = decrypt_data(&result.ciphertext, &result.nonce, CipherAlgorithm::ChaCha20Poly1305).unwrap();
        assert_eq!(plaintext.to_vec(), decrypted);
    }
}