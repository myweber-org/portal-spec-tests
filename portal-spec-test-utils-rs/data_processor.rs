...
mod tests {
    ...
    fn test_statistics() {
        let mut processor = DataProcessor::new();
        processor.records.push(DataRecord::new(1, 80.0, "cat_a"));
        processor.records.push(DataRecord::new(2, 90.0, "cat_b"));
        processor.records.push(DataRecord::new(3, 110.0, "cat_c"));

        let stats = processor.get_statistics();
        assert_eq!(stats.0, 3);
        assert_eq!(stats.1, 2);
        assert_eq!(stats.2, Some(85.0));
    }
}