...
mod tests {
    ...
    fn test_log_parsing() {
        ...
        writeln!(temp_file, "[2024-01-15 10:31:10] ERROR: Database connection failed").unwrap();
        writeln!(temp_file, "[2024-01-15 10:32:00] INFO: User login successful").unwrap();
        ...
        assert_eq!(analyzer.filter_by_level("INFO").len(), 2);
    }
}