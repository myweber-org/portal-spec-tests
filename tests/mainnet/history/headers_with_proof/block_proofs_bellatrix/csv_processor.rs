...
pub fn parse_csv(file_path: &str) -> Result<Vec<Record>, Box<dyn Error>> {
    ...
    for (index, line) in reader.lines().enumerate() {
        ...
        if fields.len() != 4 {
            return Err(format!("Invalid number of fields at line {}", index + 1).into());
        }
...
pub fn validate_records(records: &[Record]) -> Vec<String> {
    ...
    for record in records {
        ...
        if record.id == 0 {
            errors.push(format!("Record has invalid ID: 0"));
        }
    }
...
mod tests {
    ...
    fn test_validate_records() {
        let records = vec![
            Record { id: 1, name: "Valid".to_string(), value: 100.0, active: true },
            Record { id: 2, name: "".to_string(), value: -50.0, active: false },
        ];
    ...
    fn test_calculate_total() {
        let records = vec![
            ...
            Record { id: 2, name: "B".to_string(), value: 200.0, active: false },
            Record { id: 3, name: "C".to_string(), value: 300.0, active: true },
        ];
