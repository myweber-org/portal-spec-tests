...
mod tests {
    ...
    fn test_data_processor() {
        ...
        assert!(!groups.contains_key("TypeC"));
    }
}
use std::collections::HashMap;
...
mod tests {
    ...
    fn test_csv_loading() {
        ...
        writeln!(temp_file, "2,37.8,type_b").unwrap();
        writeln!(temp_file, "3,invalid,type_a").unwrap();
        writeln!(temp_file, "0,15.2,type_c").unwrap();
    ...
    fn test_filtering() {
        ...
        assert_eq!(alpha_records[0].id, 1);
        assert_eq!(alpha_records[1].id, 3);
    }
...
mod tests {
    ...
    fn test_add_invalid_key() {
        ...
        let result = processor.add_dataset("pressure".to_string(), vec![20.5, 25.0, 30.2]);
    ...
    fn test_add_out_of_range_value() {
        ...
        let result = processor.add_dataset("temperature".to_string(), vec![20.5, 150.0, 30.2]);
        assert!(result.is_err());
    }
