...
mod tests {
    ...
    fn test_load_from_csv() {
        ...
        csv_content += "1,item1,10.5,2024-01-01\n";
        csv_content += "2,item2,20.0,2024-01-02\n";
        csv_content += "3,item3,30.5,2024-01-03\n";
...
mod tests {
    ...
    fn test_single_value() {
        ...
        dataset.add_value(42.0);
        assert_eq!(dataset.calculate_mean(), Some(42.0));
        assert_eq!(dataset.calculate_standard_deviation(), None);
    }
    ...
    fn test_multiple_values() {
        ...
        let std_dev = dataset.calculate_standard_deviation().unwrap();
        assert!((std_dev - 10.0).abs() < 0.0001);
    }
    ...
    fn test_csv_parsing() -> Result<(), Box<dyn Error>> {
        ...
        assert!((dataset.calculate_mean().unwrap() - 15.5).abs() < 0.1);
