...
mod tests {
    ...
    fn test_data_record_validation() {
        ...
        let invalid_value = DataRecord::new(
            2,
            -10.0,
            "electronics".to_string(),
            "2024-01-15 10:30:00".to_string(),
    ...
    fn test_data_processor() {
        ...
        writeln!(temp_file, "1,100.0,electronics,2024-01-15 10:30:00").unwrap();
        writeln!(temp_file, "2,200.0,furniture,2024-01-15 11:30:00").unwrap();
        writeln!(temp_file, "3,300.0,electronics,2024-01-15 12:30:00").unwrap();
