...
mod tests {
    ...
    fn test_csv_loading() {
        ...
        writeln!(temp_file, "3,record3,30.5,2024-01-03").unwrap();
    ...
    fn test_average_calculation() {
        let mut processor = DataProcessor::new();
        processor.records.push(DataRecord::new(1, "test1".to_string(), 10.0, "2024-01-01".to_string()));
        processor.records.push(DataRecord::new(2, "test2".to_string(), 20.0, "2024-01-02".to_string()));
        processor.records.push(DataRecord::new(3, "test3".to_string(), 30.0, "2024-01-03".to_string()));
    ...
    #[test]
    fn test_filter_by_min_value() {
        let mut processor = DataProcessor::new();
        processor.records.push(DataRecord::new(1, "test1".to_string(), 10.0, "2024-01-01".to_string()));
        processor.records.push(DataRecord::new(2, "test2".to_string(), 20.0, "2024-01-02".to_string()));
        processor.records.push(DataRecord::new(3, "test3".to_string(), 30.0, "2024-01-03".to_string()));

        let filtered = processor.filter_by_min_value(20.0);
        assert_eq!(filtered.len(), 2);
...
mod tests {
    ...
    fn test_data_record_validation() {
        ...
        let invalid_value = DataRecord::new(2, -10.0, "test".to_string());
    ...
    fn test_load_from_file() {
        ...
        writeln!(temp_file, "2,25.3,CategoryB").unwrap();
