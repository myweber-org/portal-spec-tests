...
mod tests {
    ...
    fn test_password_generation() {
        ...
        assert!(PasswordGenerator::validate_strength(&password));
    }
    ...
    #[test]
    fn test_validation() {
        assert!(!PasswordGenerator::validate_strength("weak"));
        assert!(!PasswordGenerator::validate_strength("weakpass"));
        assert!(PasswordGenerator::validate_strength("StrongP@ss1"));
    }
}