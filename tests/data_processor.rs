...
mod tests {
    ...
    fn test_csv_loading() {
        ...
        writeln!(temp_file, "1,42.5,category_a,2024-01-01").unwrap();
        writeln!(temp_file, "2,37.8,category_b,2024-01-02").unwrap();
        writeln!(temp_file, "3,invalid,category_c,2024-01-03").unwrap();
