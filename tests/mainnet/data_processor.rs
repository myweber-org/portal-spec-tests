...
mod tests {
    ...
    fn test_csv_loading() {
        ...
        writeln!(temp_file, "1,42.5,type_a,2024-01-01").unwrap();
        writeln!(temp_file, "2,37.8,type_b,2024-01-02").unwrap();
        writeln!(temp_file, "invalid,data,type_c,2024-01-03").unwrap();
...
fn filter_records(records: Vec<Record>, predicate: fn(&Record) -> bool) -> Vec<Record> {
    records.into_iter()
        .filter(predicate)
        .collect()
}
...
mod tests {
    ...
    fn test_filter_function() {
        let records = vec![
            Record { id: 1, name: "Item1".to_string(), value: 15.0, active: true },
            Record { id: 2, name: "Item2".to_string(), value: 25.0, active: false },
            Record { id: 3, name: "Item3".to_string(), value: 35.0, active: true },
        ];
